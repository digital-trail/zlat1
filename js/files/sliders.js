...
function initSliders() {
  ...
  if (document.querySelector(".main-block__slider")) {
    new Swiper(".main-block__slider", {
      ...
      // effect: 'fade',
      // ? Таймер для автоматического перелистования слайдера
      autoplay: {
        delay: 3000,
  ...
  //   ! СЛАЙДЕР ДЛЯ 3 БЛОКА - КАРТОЧКИ ТОВАРА
  if (document.querySelector(".products-slider")) {
    new Swiper(".products-slider__slider", {
      ...
      watchOverflow: true,
      observeParents: true,
      // ? количество слайдов которое будет одновременно показано на экране
      slidesPerView: 4,
      spaceBetween: 30,
      parallax: true,
      //autoHeight: true,
      ...
      pagination: {
        ...
        clickable: true,
        // dynamicBullets: true, -включаем поддержку динамических буллетов   dynamicMainBullets: 7, -максимальное количество отображаемых буллетов
        dynamicBullets: true,
  ...
  //   ! СЛАЙДЕР ДЛЯ ПОСЛЕДНЕГО БЛОКА - ФОНАРИ
  if (document.querySelector(".torch-slider")) {
    new Swiper(".torch-slider__slider", {
      // Подключаем модули слайдера
      // для конкретного случая
      modules: [Navigation, Pagination, Autoplay],
  ...
  //   ! СЛАЙДЕР ДЛЯ БЛОКА - КАРТОЧКА ТОВАРА
